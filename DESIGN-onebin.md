...
| 5 | **GTK has a large runtime module surface.** | Treat GTK as Layer 1: build the toolkit statically, make required loaders/backends explicit, and verify the final `DT_NEEDED` set. GNOME Terminal is the reference recipe. |
